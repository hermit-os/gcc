...
checkinstall -D -y --exclude=build --pkggroup=main --maintainer=stefan@eonerc.rwth-aachen.de --pkgsource=https://hermitcore.org --pkgname=gcc-hermit-bootstrap --pkgversion=6.3.0 --requires="libgmp10, libmpc3" --pkglicense=GPL2 make install-gcc || exit 1
